...
$act_name = ($suggest) ? $suggest['activity_name'] : $lang['notifications.workout_suggest'];
...
$dynamic_notifications[] = [
"title" => $lang['notifications.reminder_title'],
"desc" => _n($lang['notifications.reminder_desc']),
...
<h1 class="text-4xl font-bold text-gray-800 mb-12 text-start px-4 tracking-tight"><?= $lang['notifications.title'] ?></h1>
...
<script src="update_settings.js"></script>
</body>
</html>